...
export default function Login() {
  const { signIn, signInWithGoogle, isLoading: authLoading, userCompany } = useAuth()
        ...
        <div className="bg-white py-8 px-4 shadow-lg sm:rounded-xl sm:px-10 border border-gray-100">
                ...
                <div className="flex">
                  ...
                  <div className="ml-3">
                    <p className="text-sm text-blue-700">
                      You are signed in as a member of <strong>{userCompany.name}</strong>
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              ...
              <Link href="/register" className="font-medium text-secondary hover:text-secondary/80 transition-colors">
                Sign up
              </Link>
            </p>
          </div>
